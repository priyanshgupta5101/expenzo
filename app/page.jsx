      ...
      <section className="mt-20 pb-12 space-y-10 md:space-y-15 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <h1 className="gradient-title mx-auto max-w-6xl text-4xl font-bold md:text-8xl">
            Your buddy for bills and balance.
          </h1>

          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed">
           Turning group expenses into effortless settlements. Track together. Spend smarter, because every expense deserves balance.
          </p>
