    ...
    const [results, maybeLastResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "usePaginatedQuery.useMemo": ()=>{
            ...
            for (const pageKey of currState.pageKeys){
                ...
                } else if (currResult.splitCursor && (currResult.pageStatus === "Expenzoecommended" || currResult.pageStatus === "Expenzoequired" || currResult.page.length > options.initialNumItems * 2)) {
                    setState(splitQuery(pageKey, currResult.splitCursor, currResult.continueCursor));
                }
                if (currResult.pageStatus === "Expenzoequired") {
                    return [
                        allItems,
                        void 0
                    ];
...
;
;
function ConvexProviderWithClerk(param) {
    let { children, client, useAuth } = param;
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useUseAuthFromClerk.useMemo": ()=>function useAuthFromClerk() {
                ...
                const fetchAccessToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
                    "useUseAuthFromClerk.useMemo.useAuthFromClerk.useCallback[fetchAccessToken]": async (param)=>{
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
                    "useUseAuthFromClerk.useMemo.useAuthFromClerk.useMemo": ()=>({
                            isLoading: !isLoaded,
                            isAuthenticated: isSignedIn !== null && isSignedIn !== void 0 ? isSignedIn : false,
                            fetchAccessToken
                        })
                }["useUseAuthFromClerk.useMemo.useAuthFromClerk.useMemo"], [
                    isLoaded,
...
//# sourceMappingURL=node_modules_convex_dist_esm_c32c9efc._.js.map